          ...
          {ripples.map((r) => (
            <motion.span
              ...
              style={{
                ...
                marginLeft: -60,
                marginTop: -60,
                boxShadow: '0 0 20px rgba(0,212,255,0.4), inset 0 0 20px rgba(0,212,255,0.2)',
              }}
            />
          ))}
        </AnimatePresence>
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-lg mb-8 leading-relaxed">
            Aqua Flow is an advanced smart water management system providing real-time water tracking and usage control to optimize efficiency and prevent waste.
          </p>
